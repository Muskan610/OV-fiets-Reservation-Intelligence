...
Artifacts (all in the current working directory):
...
RETURNS_PATH    = "ov_fiets_with_returns.csv"
BIKE_COUNT_PATH = "ov_fiets_hourly_bike_count.csv"
...
OUT_MODEL       = "forecast_demand_lgb.pkl"
OUT_ENC         = "forecast_demand_encoders.pkl"
OUT_PRED        = "forecast_demand_predictions.csv"
OUT_CONF        = "forecast_demand_pressure_confusion.png"
OUT_PER_STATION = "forecast_demand_per_station_metrics.csv"
OUT_FI          = "forecast_demand_lgb_importance.png"
...
print("\nSaved artifacts in current working directory.")
...
print("  Artifacts written in current working directory.")
